...
class AreaStarPage extends StatefulWidget {
  final int pageSize;

  AreaStarPage({Key? key, this.pageSize = 7}) : super(key: key);

  @override
  _AreaStarPageState createState() => _AreaStarPageState();
}

class _AreaStarPageState extends State<AreaStarPage> {
  int _page = 1;
  late UserInfo user;
