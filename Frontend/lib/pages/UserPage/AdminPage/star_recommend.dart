...
class StarRecommendPage extends StatefulWidget {
  final int pageSize;

  StarRecommendPage({Key? key, this.pageSize = 7}) : super(key: key);

  @override
  _StarRecommendPageState createState() => _StarRecommendPageState();
}

class _StarRecommendPageState extends State<StarRecommendPage> {
  int _page = 1;
                                        ...
                                        return Material(
                                          ...
                                          child: InkWell(
                                            onTap: () {
                                              ...
                                              starRecommend.recommendID[number-1] = _user["user_id"];
